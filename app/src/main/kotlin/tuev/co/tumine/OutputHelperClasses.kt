...
public class OutputHelperClasses {
    ...
    public class VersionInfo(public var minerVersion: String,
                                  public var libuvVersion: String,
                                  public var compilerVersion: String)

    public class BasicStartInfo(public var threads: Int?,
                                     public var algorithm: MiningAlgorithm?,
                                     public var miningVariant: Int?)

    public class CpuInfo(public var name: String,
    ...
    public class MiningJobResult(public var error: String?,
                                      public var accepted: Int?,
                                      public var rejected: Int?,
                                      public var difficulty: Int?,
                                      public var elapsedInMs: Int?)

    public class MiningJob(public var url: String,
                                public var difficulty: Int?,
                                public var algorithm: MiningAlgorithm?,
                                public var algoVariant: MiningVariant?)

    public class Hashrate(public var ShortInterval: Double?,
                               public var MediumInterval: Double?,
                               public var LargeInterval: Double?,
                               public var Highest: Double?)

    public class HashratePerThread(public var index: Int?,
                                 public val affinity: String,
                                 public var ShortInterval: Double?,
                                 public var MediumInterval: Double?,
                                 public var LargeInterval: Double?)

    public class StartMiningInfo(public var threads: Int?,
                                      public var ways: Int?,
                                      public var memoryInMB: Double?)

    public class InitInfo(public var pkg: String?,
                               public var paid: Boolean = false,
                               public var percentageToMe: Int?)

    public class Debuginfo(public var basicStartInfo: OutputHelperClasses.BasicStartInfo?,
    ...
    public class SslInfo(public var tlsVersion: String?,
